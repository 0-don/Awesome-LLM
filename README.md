...
- [UnoRouter](https://unorouter.com) - An OpenAI-compatible LLM gateway exposing one API key for every major provider, with smart routing across models. Works as a drop-in endpoint for code, Claude Code, and chat clients like SillyTavern, Janitor.AI, RisuAI, and Chub.
